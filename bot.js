...
const { NutritionDialog } = require('./dialogs/nutrition/nutrition');

// Greeting Dialog ID
const GREETING_DIALOG = 'greetingDialog';

// Nutrition Dialoge ID
const NUTRITION_DIALOG = 'nutritionDialog'
...
class BasicBot {
    ...
    async onTurn(context) {
        // console.log('ctx', context['_activity'].text);
